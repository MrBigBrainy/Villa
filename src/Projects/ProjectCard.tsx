...
function ProjectCard({ heading, alt, image, bedRoom, bathRoom, area }: ProjectCardProp) {
  ...
  return (
    <MotionCard whileHover={{ scale: 1.03 }}
whileTap={{ scale: 0.97 }}
 className=" pt-0! rounded-l-lg! py-0!" ref={projectCardRef} initial={defaultInitial} animate={isInView ? { opacity: 1, y: 0, transition: { type: "tween", duration: 0.3 } } : { opacity: 0, y: -50, transition: { type: "tween", duration: 0.3 } }}>
